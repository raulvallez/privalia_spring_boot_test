...
public class SwaggerConfig {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				.paths(regex("/product.*")) 
				.build().apiInfo(metaData()); //Aplicame Swagger a todo lo que sea esta url
	}
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfo("Spring Boot REST API", 
				...
				"1.0",
				"Terms of service",
				new Contact("Raul Vallez", "https://www.enterpriseconsulting.es","mail@enterpriseconsulting.es"),
